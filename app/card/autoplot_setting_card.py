...
from qfluentwidgets import ExpandSettingCard, FluentIconBase, SwitchButton, IndicatorPosition, RadioButton, SpinBox, CheckBox
...
class AutoPlotSettingCard(ExpandSettingCard):
    ...
    def _init_options(self):
        ...
        mode_label = QLabel(self.tr("对话模式:"), mode_widget)
