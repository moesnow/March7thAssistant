...
- 支持在设置中单独更新模拟宇宙版本，未来日志中不再说明
- 图形界面增加”更新日志“、”常见问题“等子页面
- 图形界面支持手动检测更新
- 更新模拟宇宙 [Auto_Simulated_Universe v5.33](https://github.com/CHNZYX/Auto_Simulated_Universe/tree/fe83a9a050a12193bf287553758e9032bb3724b4)
### 修复
- 优化模拟宇宙完成后的通知截图
