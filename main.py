...
def first_run():
    if not is_docker_started() and not cfg.get_value(
        base64.b64decode("YXV0b191cGRhdGU=").decode("utf-8")
    ):
...
def run_notify_action():
    notif.notify(
        content=cfg.notify_template["TestMessage"],
        image="./assets/app/images/March7th.jpg",
