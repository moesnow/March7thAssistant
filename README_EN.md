...
For more details, refer to the [configuration file](assets/config/config.example.yaml) or the graphical user interface settings. | 🌟 If you like it, please give it a star! |･ω･) 🌟 | Join our QQ group [click here](https://qm.qq.com/q/LpfAkDPlWa) or TG group [click here](https://t.me/+ZgH5zpvFS8o0NGI1).
